...
test_cases = {1:[[[2.16135,-1.42635,1.55109],
              ...
              4:[[[-0.730743,1.19105,0.62152],
		  [-0.0889199,-0.340848,0.914093,0.200871]],
		  [-0.456986,1.06142,0.629285],
		  [1.98,0.14,0.96,5.49,-1.20,5.89]],
              5:[]}
...
def test_code(test_case):
    ...
    R_EE = R_EE.subs({'r':roll,'p':pitch,'y':yaw}) *  R_Corr
    ## Insert IK code here!
	...
	print("Test Case ee X position:" , test_case[0][0][0], test_case[0][0][1],test_case[0][0][2])
